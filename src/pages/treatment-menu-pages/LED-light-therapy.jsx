            ...
            <div className="row">
                <div className="lightTherapy__container">
                    ...
                    <div className="heading__para">
                        <h3>What is LED Light Therapy?</h3>
                        <p>
                    ...
                    <div className="heading__para">
                        <h3>What are the different lights/colours and what do they treat?</h3>
                        <p>
                    ...
                    <div className="heading__para">
                        <h3>LED explained in more detail</h3>
                        <p>
